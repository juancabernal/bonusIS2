package co.edu.uco.ucochallenge.application.user.register.usecase.impl;
...
import co.edu.uco.ucochallenge.domain.user.register.validation.RegisterUserDomainValidator;
@Service
@Transactional
