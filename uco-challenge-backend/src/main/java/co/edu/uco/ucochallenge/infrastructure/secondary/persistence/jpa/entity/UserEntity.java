package co.edu.uco.ucochallenge.infrastructure.secondary.persistence.jpa.entity;

import java.util.UUID;

import co.edu.uco.ucochallenge.crosscutting.helper.ObjectHelper;
...
public class UserEntity {
    ...
    // ⬇️ AHORA mapeados a las columnas reales de la tabla (NOT NULL)
    @Column(name = "email_confirmed_is_default_value", nullable = false)
    private boolean emailConfirmedIsDefaultValue = false;

    @Column(name = "mobile_number_confirmed_is_default_value", nullable = false)
    private boolean mobileNumberConfirmedIsDefaultValue = false;
    ...
    protected UserEntity() {
        ...
        // Siempre false para que nunca se intente guardar NULL
    ...
    public static final class Builder {
        ...
        private boolean emailConfirmed;
        private boolean mobileNumberConfirmed;
        // por defecto false, para que la BD reciba siempre false
        private boolean emailConfirmedIsDefaultValue = false;
        private boolean mobileNumberConfirmedIsDefaultValue = false;
        ...
        public Builder emailConfirmed(final boolean emailConfirmed) {
            ...
            // ya está en false por defecto, pero lo dejamos explícito
        ...
        public Builder emailConfirmedIsDefaultValue(final boolean value) {
            this.emailConfirmedIsDefaultValue = value;
            return this;
        }

        public Builder mobileNumberConfirmedIsDefaultValue(final boolean value) {
